...
def check_result()
  ...
  precision=[]
  candidates=[]
  label = "Fri Jul 20 09:26:21"
  File.open("/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/NYTIMES-DBPEDIA-GEO/reference/reference.txt", 'r').each { |line|
  ...
  File.open( "/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/NYTIMES-DBPEDIA-GEO/output/#{label} +0200 2012_mappings.txt", 'r').each { |line|
  ...
  File.open(  "/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/NYTIMES-DBPEDIA-GEO/output/#{label} +0200 2012_subjects.txt", 'r').each { |line|
    subjects << line.rstrip
  }
   

  File.open( "/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/NYTIMES-DBPEDIA-GEO/output/#{label} +0200 2012_candidates.txt", 'r').each { |line|
