...
def check_result()
  ...
  precision=[]
  candidates=[]
  label = "Sat Jul 21 14:55:00"
  File.open("/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/SIDER-DBPEDIA/reference/reference.txt", 'r').each { |line|
  ...
  File.open( "/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/SIDER-DBPEDIA/output/#{label} +0200 2012_mappings.txt", 'r').each { |line|
  ...
  File.open(  "/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/SIDER-DBPEDIA/output/#{label} +0200 2012_subjects.txt", 'r').each { |line|
    subjects << line.rstrip
  }
   

  File.open( "/Users/samuraraujo/Documents/workspace2/ManyExperiments/experiments/HeuristicSearchApproach/SIDER-DBPEDIA/output/#{label} +0200 2012_candidates.txt", 'r').each { |line|
